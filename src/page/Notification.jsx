  ...
  return (
    <div className="px-4 py-12">
      ...
      <div className="w-full max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
        ...
        <div className="bg-gray-50 rounded-lg border border-gray-200 p-4 mb-8 overflow-hidden">
          <div ref={scrollerRef1} className="scroller h-48 overflow-hidden">
            <div className="scroller-content space-y-4">
              {updates.map((update, index) => (
                <div key={index} className="flex items-start space-x-3">
                  <img
                    src="/assets/decree.png"
                    alt="Notice"
        ...
        <div className="bg-gray-50 rounded-lg border border-gray-200 p-4 overflow-hidden">
          <div ref={scrollerRef2} className="scroller h-48 overflow-hidden">
            <div className="scroller-content space-y-4">
