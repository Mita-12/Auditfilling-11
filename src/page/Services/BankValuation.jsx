  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto w-full px-4 sm:px-6 lg:px-8 mt-20 sm:mt-25 py-6 sm:py-10 flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
        ...
        {/* Main Content */}
        <main className={`flex-1 space-y-6 sm:space-y-8 lg:space-y-12  ${!isMobile ? 'lg:mr-1 ' : ''}`}>
          {/* Menu Overview */}
          ...
          {services.map((service, idx) => (
            ...
            >
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-serif font-bold text-center mb-4 text-gray-900">
                {service.service_name || service.name}
              </h1>
              <div
                className="prose prose-sm sm:prose-base text-justify max-w-none text-gray-700"
