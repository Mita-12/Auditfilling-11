...
//    const navigate = useNavigate();// Added missing state
...
//             <div className="mb-4">
//               <label htmlFor="service-desktop" className="block text-gray-700 font-medium mb-1">
//                 Select Service
//               </label>
//               <select
//                 id="service-desktop"
  ...
  return (
    <div className="min-h-screen ">
      ...
      <div className="mx-auto w-full px-4 sm:px-6 lg:px-8 mt-20 sm:mt-25 py-6 sm:py-10 flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
        ...
        {!isMobile && (
          <nav className={`flex-none ${isTablet ? 'lg:w-64' : 'xl:w-80'} sticky top-24 self-start ml-18 bg-white  p-4 sm:p-6 h-auto overflow-y-auto  scrollbar-thin scrollbar-thumb-blue-300 scrollbar-track-gray-100 scrollbar-thumb-rounded-full scrollbar-track-rounded-full hover:scrollbar-thumb-blue-400 transition-colors`}>
            <h1 className="text-xl  font-serif mb-4 sm:mb-5 text-gray-800">
              {menuData.name || menuData.menu_name || "Trademark"}
            </h1>
          ...
          <div className={`flex-none ${isTablet ? 'lg:w-60' : 'xl:w-72'} space-y-4 `}>
            <div className="sticky top-24 space-y-4 mr-15 ">
              ...
              <div className="bg-white shadow-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 w-full border border-gray-100">
                ...
                <p className="text-gray-500 text-center text-xs sm:text-sm mb-2 ">
                  Choose your Trademark service to continue with payment
                </p>
